...
function renderReport(report: IntakeReport, baseUrl: string) {
  ...
  side.innerHTML = '<section><h2>Summary</h2><dl>' +
    ...
    '</dl></section><section><h2>Policy</h2><ul><li>Cloud/Sense review is still required for visual acceptance.</li><li>Generated staged files are diagnostic copies only.</li><li>Fused moving systems are retopo/reference candidates, not runtime-ready parts.</li></ul></section>';
