...
const visualBuild = 'tftm-authored-sherman-treads-v1-4-20260705';
...
new GLTFLoader().load(AUTHORED_SHERMAN_TREADS_GLB_URL, (gltf) => {
  ...
  scene.add(model);
  statusEl.textContent = 'loaded v1.4 tread assembly: crisp rims, smooth tire bands, profile opening preserved; no hull or turret';
