...
const visualBuild = 'tftm-authored-sherman-treads-v1-9-20260705';
...
new GLTFLoader().load(AUTHORED_SHERMAN_TREADS_GLB_URL, (gltf) => {
  ...
  scene.add(model);
  statusEl.textContent = 'loaded v1.9 tread assembly: open running gear, visible track runs, exposed wheels in profile opening; no hull or turret';
