...
const visualBuild = 'tftm-authored-sherman-treads-v1-10-20260705';
...
new GLTFLoader().load(AUTHORED_SHERMAN_TREADS_GLB_URL, (gltf) => {
  ...
  scene.add(model);
  statusEl.textContent = 'loaded v1.10 tread assembly: restored continuous tread geometry, smooth shading normals, profile opening preserved; no hull or turret';
