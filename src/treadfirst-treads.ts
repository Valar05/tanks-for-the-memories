...
const visualBuild = 'tftm-authored-sherman-treads-v1-3-20260705';
...
new GLTFLoader().load(AUTHORED_SHERMAN_TREADS_GLB_URL, (gltf) => {
  ...
  scene.add(model);
  statusEl.textContent = 'loaded v1.3 tread assembly: wheels occupy the tread profile opening; no hull or turret';
