...
const visualBuild = 'tftm-authored-sherman-treads-v1-7-20260705';
...
new GLTFLoader().load(AUTHORED_SHERMAN_TREADS_GLB_URL, (gltf) => {
  ...
  scene.add(model);
  statusEl.textContent = 'loaded v1.7 tread assembly: smooth continuous tread belt, baked rim loops, profile opening preserved; no hull or turret';
