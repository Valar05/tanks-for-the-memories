...
const visualBuild = 'tftm-authored-sherman-treads-v1-8-20260705';
...
new GLTFLoader().load(AUTHORED_SHERMAN_TREADS_GLB_URL, (gltf) => {
  ...
  scene.add(model);
  statusEl.textContent = 'loaded v1.8 tread assembly: custom smooth belt normals, baked rim loops, profile opening preserved; no hull or turret';
