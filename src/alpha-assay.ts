...
const visualQaBuild = 'tftm-commander-platoon-retexture-v1-20260704a';
const variants = [
  {
    id: 'alpha',
    label: 'Alpha',
  ...
  },
  {
    ...
    role: 'Assault',
    mood: 'restless / fast',
    url: './tftm/models/m4a3_75_vvss_sherman_bravo_retexture_v1/m4a3_75_vvss_sherman_bravo_retexture_v1.glb',
    x: -1.7,
    z: -0.15,
    yaw: -0.28
  },
  {
    ...
    role: 'Human',
    mood: 'warm / lived-in',
    url: './tftm/models/m4a3_75_vvss_sherman_tango_retexture_v1/m4a3_75_vvss_sherman_tango_retexture_v1.glb',
    x: 1.7,
    z: -0.15,
    yaw: 0.28
  },
  {
    ...
    url: './tftm/models/m4a3_75_vvss_sherman_delta_retexture_v1/m4a3_75_vvss_sherman_delta_retexture_v1.glb',
    x: 5.1,
    z: 0.35,
    yaw: 0.5
  }
...
root.innerHTML = '<main class="alpha-shell">' +
  '<header class="alpha-head">' +
    '<div class="alpha-title">' +
      ...
      '<p>Four commander texture variants. One accepted vanilla base mesh. Texture language only.</p>' +
    '</div>' +
