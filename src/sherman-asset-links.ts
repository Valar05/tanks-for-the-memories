...
export const AUTHORED_SHERMAN_TREADS_GLB_URL = './tftm/models/authored_sherman_treads_v1/authored_sherman_treads_v1.glb?v=v1-7-smooth-continuous-tread-belt';
