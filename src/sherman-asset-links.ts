...
export const MESHY_SHERMAN_LOWPOLY_ENVELOPE_BASE_URL = './tftm/models/meshy_sherman_lowpoly_envelope_v1/';
const MESHY_SHERMAN_LOWPOLY_ENVELOPE_CACHE = '?v=v1-direct-lowpoly-pbr-20260708';
export const MESHY_SHERMAN_LOWPOLY_ENVELOPE_MANIFEST_URL = MESHY_SHERMAN_LOWPOLY_ENVELOPE_BASE_URL + 'lowpoly_manifest.json' + MESHY_SHERMAN_LOWPOLY_ENVELOPE_CACHE;

export const MESHY_SHERMAN_ENVELOPE_ASSEMBLY_BASE_URL = './tftm/models/meshy_sherman_envelope_assembly_v1/';
const MESHY_SHERMAN_ENVELOPE_ASSEMBLY_CACHE = '?v=v1-textured-envelope-assembly-20260708';
export const MESHY_SHERMAN_ENVELOPE_ASSEMBLY_MANIFEST_URL = MESHY_SHERMAN_ENVELOPE_ASSEMBLY_BASE_URL + 'envelope_manifest.json' + MESHY_SHERMAN_ENVELOPE_ASSEMBLY_CACHE;
