...
const blenderScript = path.join(root, 'scripts', 'export_authored_sherman_hero.py');
...
const plateColors = {
  hull_glacis: '#5c6b40', hull_left: '#54643d', hull_right: '#54643d', hull_rear: '#455333', engine_deck: '#4f603a',
  turret_front: '#607045', turret_left: '#586741', turret_right: '#586741', turret_top: '#65764a', turret_bustle: '#52623d',
  mantlet: '#454939', barrel_strip: '#3f4236', coaxial_mg: '#141511', track_outer: '#27261f', track_inner_top_bottom: '#333026',
