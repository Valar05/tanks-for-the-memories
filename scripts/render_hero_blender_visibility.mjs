...
const blenderScript = path.join(root, 'scripts', 'render_hero_blender_visibility.py');
const contactScript = path.join(root, 'scripts', 'build_hero_blender_visibility_contact_sheet.py');
const manifestPath = path.join(root, 'generated', 'blender-visibility', 'authored_sherman_hero_v1', 'manifest.json');
