...
const releaseManifest = {
  ...
  authored_boxmodel_review: {
    ...
    expected_build: 'tftm-authored-sherman-boxmodel-v1-4-20260704',
  ...
  required_cloud_captures: [
    'boxmodel-tank phone portrait showing authored_sherman_boxmodel_v1 and build token tftm-authored-sherman-boxmodel-v1-4-20260704',
