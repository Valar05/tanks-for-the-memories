...
const releaseManifest = {
  ...
  authored_boxmodel_review: {
    ...
    tuner_expected_build: 'tftm-authored-sherman-boxmodel-tuner-v7-20260704',
  ...
  required_cloud_captures: [
    ...
    'boxmodel-tank.html?tune=1 phone portrait showing gesture-only part tuner with collapsed parts drawer, front-right/front-left/rear-right/rear-left hull-colored sloped trapezoid plug parts aligned parallel to the tracks, selected plug highlight, camera orientation widget, explicit All/X/Y/Z scale axis buttons, square unskewed tank frame, and build token tftm-authored-sherman-boxmodel-tuner-v7-20260704',
    'boxmodel-tank.html?tune=1 cloud interaction evidence showing one selected sloped trapezoid plug visibly move/rotate/scale through drag/pinch/twist while other enabled plugs remain placed, OrbitControls camera orbit/dolly/pan preserved from an unskewed model frame, and no object transform handles',
