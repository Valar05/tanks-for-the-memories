...
const releaseManifest = {
  ...
  required_cloud_captures: [
    ...
    'boxmodel-tank close-up review showing integrated sponson/skirt hull-side coverage at front-left, front-right, rear-left, and rear-right as attached armor, solidified armor plates, barrel/mantlet/coaxial MG ownership, and box UV plate paintability',
  ...
  sense_simulation_questions: [
    ...
    'Do the new reshaped sloped sponson skins bridge the hull side into the outer track skirt at front-left, front-right, rear-left, and rear-right corners, without pasted panels or blockers?',
