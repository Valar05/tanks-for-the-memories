...
const releaseManifest = {
  ...
  authored_boxmodel_review: {
    ...
    expected_build: 'tftm-authored-sherman-boxmodel-v1-10-20260705',
  ...
  required_cloud_captures: [
    'boxmodel-tank phone portrait showing authored_sherman_boxmodel_v1 and build token tftm-authored-sherman-boxmodel-v1-10-20260705',
    'boxmodel-tank phone landscape showing Sherman silhouette, joined armor mass, non-cube turret, integrated sponson/skirt hull-side coverage at front-left, front-right, rear-left, and rear-right hull/track corners, and no local capture',
    'boxmodel-tank close-up review showing integrated sponson/skirt hull-side coverage at front-left, front-right, rear-left, and rear-right as attached armor, no raycast-accessible interior through those gaps, solidified armor plates, barrel/mantlet/coaxial MG ownership, and box UV plate paintability',
  ...
  false_change_penalty: {
    ...
    required_next_evidence: 'Next tank visual pass must show cloud/Sense evidence that v1-10 integrated sponson/skirt hull-side armor visibly closes the front and rear hull/track corner gaps on all four corners.'
  },
  sense_simulation_questions: [
    'Does authored_sherman_boxmodel_v1 build v1-10 preserve the Sherman silhouette while integrating sponson/skirt hull-side coverage across all four hull/track corners?',
    ...
    'Do the new reshaped sloped sponson skins bridge the hull side into the outer track skirt at front-left, front-right, rear-left, and rear-right corners, and would outside gap raycasts hit exterior armor before entering the tank interior, without pasted panels or blockers?',
