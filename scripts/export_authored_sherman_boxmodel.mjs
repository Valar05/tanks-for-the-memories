...
function writePlate(file, id, color, guide) {
  const script = [
    ...
    '    d.rectangle((96, 96, 928, 928), outline=(37, 41, 30, 58), width=3)',
    ...
    '        x1 = x0 + rng.randint(20, 90)',
    '        d.line((x0, y0, x1, y0 + rng.randint(-2, 2)), fill=(30, 34, 24, rng.randint(8, 20)), width=rng.randint(1, 2))',
    'img.save(file)'
  ].join('\n');
