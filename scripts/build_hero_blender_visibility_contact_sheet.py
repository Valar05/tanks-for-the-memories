...
OUT = ROOT / 'generated' / 'blender-visibility' / 'authored_sherman_hero_v1'
...
def main():
    ...
    label_font = font(18)
    small_font = font(14)
    draw.text((PAD, PAD), 'Authored Sherman Hero - Offline Blender Visibility', fill=TEXT, font=title_font)
