...
const blenderScript = path.join(root, 'scripts', 'render_armored_blender_visibility.py');
const contactScript = path.join(root, 'scripts', 'build_armored_blender_visibility_contact_sheet.py');
const manifestPath = path.join(root, 'generated', 'blender-visibility', 'authored_sherman_armored_v1', 'manifest.json');
